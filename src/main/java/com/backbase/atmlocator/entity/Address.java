...
public class Address {
    ...
    public String toString() {
        return new StringBuilder().append("{street: ").append(street).append(", housenumber: ").append(housenumber)
                .append(", postalcode: ").append(postalcode).append(", city: ").append(city).append(", ")
                .append(geoLocation).append("}").toString();
    }
